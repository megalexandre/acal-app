...
export const deleteInvoiceSuccess = createAction('[Data] Delete Invoice Success', props<{ id: string }>());
export const deleteInvoiceFailure = createAction('[Data] Delete Invoice Failure', props<{ error: string }>());

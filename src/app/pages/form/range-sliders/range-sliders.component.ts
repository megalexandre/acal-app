...
export class RangeSlidersComponent implements OnInit {
  ...
  tickValueoptions: Options = {
    ...
    stepsArray: [{ value: 1, legend: 'Very poor' }, { value: 2 }, { value: 3, legend: 'Fair' }, { value: 4 }, { value: 5, legend: 'Average' }, { value: 6 }, { value: 7, legend: 'Good' }, { value: 8 }, { value: 9, legend: 'Excellent' }],
  };

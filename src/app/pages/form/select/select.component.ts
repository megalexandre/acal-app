...
export class SelectComponent implements OnInit {
  ...
  Options = [{ name: 'Label Five' }, { name: 'Label Four', disabled: true }, { name: 'Label One' }, { name: 'Label Six' }, { name: 'Label Three' }, { name: 'Label Two', disabled: true }, { name: 'Zero' }];

  /**
   * Option Disabled groups Select2
   */
  searchselectedOption = 'Label Six';
  searchOptions = [{ name: 'Label Five' }, { name: 'Label Four', disabled: true }, { name: 'Label One' }, { name: 'Label Six' }, { name: 'Label Three' }, { name: 'Label Two', disabled: true }, { name: 'Zero' }];

...
export class LeafletComponent implements OnInit {
  ...
  GroupsLayers = [marker([39.61, -105.02]).bindPopup('This is Littleton'), marker([39.74, -104.99]).bindPopup('This is Denver'), marker([39.73, -104.8]).bindPopup('This is Aurora'), marker([39.77, -105.23]).bindPopup('This is Golden')];
}
